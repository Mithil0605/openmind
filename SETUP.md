...
This is the simplest way to install OpenMind v4.
...
1. Download or unzip the `openmind-v4` folder.
2. Open the folder.
...
Open a terminal in the `openmind-v4` folder and run:
...
OpenMind v4 does not save session conversations. It stores only memories that are explicitly saved as project preferences.
